...
namespace Microsoft.ServiceBus.Configuration
{
	public sealed class MessageSecurityOverRelayOnewayElement : ConfigurationElement
	{
		...
		[ConfigurationProperty("clientCredentialType", DefaultValue=MessageCredentialType.Certificate)]
		...
		internal void ApplyConfiguration(MessageSecurityOverRelayOneway security)
		{
			if (security == null)
			{
		...
		internal void InitializeFrom(MessageSecurityOverRelayOneway security)
		{
			if (security == null)
			{
				throw Microsoft.ServiceBus.Diagnostics.DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull("security");
