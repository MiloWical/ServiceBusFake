...
{
	[MessageContract(WrapperName="ConnectRetry", WrapperNamespace="http://schemas.microsoft.com/netservices/2009/05/servicebus/directconnect", IsWrapped=true)]
	internal class ConnectRetryMessage : IExtensibleDataObject
	{
